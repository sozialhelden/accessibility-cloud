  ...
  'input textarea#streamChain'(event, instance) {
    ...
    for (let i = 0; i < chain.length; i++) {
      ...
      if (missingPaths.length) {
        addError(`Invalid mapping paths:<ul><li>${missingPaths.join('</li><li>')}</li> — <a href="https://github.com/sozialhelden//blob/master/docs/exchange-format.md#a-complete-sample-object">see format documentation</a></ul>`);
      }
    }
  },
});
