...
export function importFromTransifex(resourceSlug: string, locale: string) {
...
export function exportToTransifex({ resourceSlug, poFile, asSourceFile, isNewResource }: ExportOptions) {
  check(resourceSlug, String);
  check(poFile, Object);
