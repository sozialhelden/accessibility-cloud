...
export function setAccessControlHeaders(res, methodsArray = null) {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Accept, Accept-Encoding, Accept-Language, Cache-Control, Connection, Referer, User-Agent, X-Requested-With, X-Token, X-App-Token, X-User-Token, Content-Type');
